...
REPORT_WRITING_PROMPT = (
    ...
    "When web research is provided, you MUST include a References and Sources section citing those sources. "
    ...
    "When refining an existing draft, return the FULL executive_summary with every section: "
    "copy unchanged sections exactly, revise only what the user asked to change, and keep References "
    "and Sources unless the user asked to refresh citations. Never return only the changed paragraphs. "
